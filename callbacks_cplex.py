...
class branch_attach_data2(BranchCallback):
    ...
    def __call__(self):
        ...
        for branch_idx in range(nBranch):
            ...
            # try to branch
        #     if self.scores[var_idx]>maxScore:
        #         maxScore = self.scores[var_idx]
        #         maxBranchInfo = (node_estimate, var_info)
        # if maxScore> 0.99:
        #     self.make_branch(maxBranchInfo[0],maxBranchInfo[1])
        #     maxScore = 0
